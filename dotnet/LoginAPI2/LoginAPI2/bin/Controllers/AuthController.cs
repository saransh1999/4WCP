...
namespace LoginAPI2.Controllers
{
	...
	public class AuthController : ControllerBase
	{
		...
		{
			var employee = _context.Decodemanagers.FirstOrDefault(e => e.ResourceId.ToString()==request.employee_id);
			...
			user.accessToken = CreateToken(employee.ResourceId.ToString(), employee.IsManager);
